 ...
 * -----
 * 
 * thewolves.action.php
 *
 * TheWolves main action entry point
 *
 *
 ...
 * this.ajaxcall( "/thewolves/thewolves/myAction.html", ...)
 *
 */
  
class action_thewolves extends APP_GameAction {
