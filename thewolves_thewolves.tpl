...
const jstpl_piece =
    `<div id="wolves-piece-\${id}" class="wolves-piece" data-kind="\${kind}" data-owner="\${owner}">
        ...
        <div class="wolves-piece-shadow"></div>
...
const jstpl_player_status =
    `<div class="wolves-player-overview">
        ...
        <div class="wolves-player-status">
            <div id="wolves-status-icon-pack-\${playerId}" class="wolves-status-icon wolves-status-icon-pack" data-attribute="pack" data-value="\${packSpread}">
            ...
            <div id="wolves-status-icon-speed-\${playerId}" class="wolves-status-icon wolves-status-icon-speed" data-attribute="speed" data-value="\${moveRange}">
                <svg viewBox="-1 -1 11 11">
            ...
            <div id="wolves-status-icon-howl-\${playerId}" class="wolves-status-icon wolves-status-icon-howl" data-attribute="howl" data-value="\${howlRange}">
                <svg viewBox="-1 -1 11 11">
            ...
            <div id="wolves-status-icon-terrain-\${playerId}" class="wolves-status-icon wolves-status-icon-terrain" data-attribute="terrain" data-value="\${terrainTokens}"></div>
            <div id="wolves-status-icon-action-\${playerId}" class="wolves-status-icon wolves-status-icon-action" data-attribute="action" data-value="\${actionTokens}"></div>
        </div>
        <div id="wolves-scoring-tokens-\${playerId}" class="wolves-scoring-tokens">
        </div>
    <div class="wolves-player-overview">`;
